...
//  hw4
//
//  Created by Zhen Yang on 3/11/16.
//
//
...
////    FILE *temp1=fopen("a.in","wb+");
////    FILE *temp2=fopen("b.in","wb+");;
////    encrypt(s,f,p,decrypt,temp1);
////    fseek(temp1,0,SEEK_SET);
////    encrypt(s+16,f,temp1,(decrypt+1)%2,temp2);
////    fseek(temp2,0,SEEK_SET);
////    
////    encrypt(s+32,f,temp2,decrypt,NULL);
//    
//    
//    
//    return;
